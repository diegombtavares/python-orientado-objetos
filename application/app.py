...
def exibir_opcoes():
    ''' Função respoção por exibição das opções'''
...
def alternar_estado_restaurante():
    ''' Função responsável por alternar status do restaurante '''
...
def escolher_opcao():
    ''' Função responsável pelo tratamento das opções '''
    try:
